...
/**
 * @author LvZheng
 * 创建时间：2021/2/18 下午2:39
 */
public class CommonUtil {
    public static void main(String[] args) {
        /**   Lang 中工具类比较多，这里介绍几个主要的：
         　　ClassUtils：getShortClassName，这个函数应该在 java.lang.Class 类中有的，我看到很多人自己写这个函数。getAllInterfaces，convertClassNamesToClasses，
         isAssignable，primitivesToWrappers，isInnerClass。
         　　NumberUtils：关于数字以及数字和字符串转换的类 stringToInt，toDouble，createNumber，isAllZeros，int compare ( float lhs, float rhs)，
         isNumber(String str)，double min ( double[] array)。
        ...
        NumberUtils.createBigDecimal("12");
        System.out.println(RandomStringUtils.random(3, "utf-8"));
